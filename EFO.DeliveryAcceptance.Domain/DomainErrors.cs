...
{
    public static readonly string ComponentIdIsInvalid = nameof(ComponentIdIsInvalid);
    ...
    public static readonly string ComponentNameIsInvalid = nameof(ComponentNameIsInvalid);
